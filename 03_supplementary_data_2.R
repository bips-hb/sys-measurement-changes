...
wb <- openxlsx2::wb_add_worksheet(wb, "Lognormal Distribution") %>%
  openxlsx2::wb_add_data(
    sheet = "Lognormal Distribution",
...
openxlsx2::wb_save(wb, "results/supplementary_data_2.xlsx")
